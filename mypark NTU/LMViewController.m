...
//  LMGaugeView
//
//  Created by MR.Robot 💀 on 11/03/2018.
...
#define kMyRedColor   [UIColor colorWithRed:76.0/255 green:217.0/255 blue:100.0/255 alpha:1]
#define kMyGreenColor [UIColor colorWithRed:11.0/255 green:150.0/255 blue:246.0/255 alpha:1]
#define kMyBlueColor  [UIColor colorWithRed:255.0/255 green:59.0/255 blue:48.0/255 alpha:1]
...
@property (weak, nonatomic) IBOutlet UILabel *cliftonLabel;
...
- (IBAction)changedStyleSwitchValueChanged:(id)sender
{
    if (!self.nightModeSwitch.on)
    {
        ...
        self.cliftonLabel.textColor = [UIColor whiteColor];
    ...
    else
    {
        ...
        self.cliftonLabel.textColor = [UIColor blackColor];
